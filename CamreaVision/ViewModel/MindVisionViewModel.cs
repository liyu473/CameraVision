...
public partial class MindVisionViewModel : ViewModelBase
{
    ...
    public ObservableCollection<MindCameraInfo> Cameras { get; } = [];

    [ObservableProperty]
    [NotifyPropertyChangedFor(nameof(IsSelectedCamera))]
    [NotifyCanExecuteChangedFor(nameof(OpenCameraCommand))]
    public partial MindCameraInfo? SelectedCamera { get; set; }
    ...
    public MindVisionViewModel(IMindCameraService cameraService, ILogger<MindVisionViewModel> logger)
    {
